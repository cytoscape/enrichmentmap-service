...
public class Ranking {
	...
	public final static String GSEA_RANKING = "GSEARanking";
	public final static String RANKING_LOADED = "RankingLOADED";
	...
	private transient Map<Integer, Integer> rank2gene;
	private transient Map<Integer, Double> gene2score;
	...
	/**
	 * Get scores array (elements are in no particular order)
	 * 
	 * @return double[] scores
	 */
	public synchronized double[] getScores() {
		if (scores == null) {
			var gene2score = getGene2Score();
			scores = new double[gene2score.size()];
			int i = 0;
			
			for (var score : gene2score.values()) {
				scores[i++] = score;
			}
		}
		return scores;
