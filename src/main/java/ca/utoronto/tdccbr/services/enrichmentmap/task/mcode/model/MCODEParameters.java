...
import static ca.utoronto.tdccbr.services.enrichmentmap.task.mcode.model.MCODEAnalysisScope.NETWORK;
...
public class MCODEParameters {
	...
	public void setDefaultParams() {
		setAllAlgorithmParams(null, NETWORK, new UUID[0], false, 2, 2, 100, 0.2, false, true, 0.1);
	}
...
//	)
	...
	public UUID[] getSelectedNodes() {
		return selectedNodes;
	}

	public void setSelectedNodes(UUID[] selectedNodes) {
		this.selectedNodes = selectedNodes;
	}
