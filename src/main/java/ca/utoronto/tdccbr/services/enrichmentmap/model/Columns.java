...
public interface Columns {
	...
	public static final ColumnListDescriptor<String> NODE_NAME = new ColumnListDescriptor<>("Name", String.class);
	public static final ColumnListDescriptor<String> NODE_GS_DESCR = new ColumnListDescriptor<>("GS_DESCR", String.class);
