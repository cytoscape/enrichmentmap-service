...
public class SignatureGenesetSimilarity extends GenesetSimilarity {
	...
	public SignatureGenesetSimilarity(
			String geneset1Name,
			String geneset2Name,
			double similarityCoeffecient,
			String interactionType,
			Set<Integer> overlappingGenes,
			String datasetName
	) {
	...
	/**
	 * Set the N value used in the Hypergeometric test. 'U' denotes the size of the
	 * universe (i.e. the size of the union of all gene sets)
	 */
