...
public class GeneSet {
	...
	public static GeneSet createBaderLab(String name, String description, Set<Integer> genes, String simpleName,
			String datasource, String datasourceId) {
	...
	protected GeneSet intersectionWith(Set<Integer> expressionGenes) {
		var intersection = new HashSet<Integer>(genes);
		intersection.retainAll(expressionGenes);

		return new GeneSet(name, description, intersection, simpleName.orElse(null), source.orElse(null),
				datasourceId.orElse(null), davidCategory.orElse(null));
	}
